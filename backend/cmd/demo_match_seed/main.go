...
func ensureMinimumAchievements(svcCtx *svc.ServiceContext) error {
	defs := []model.Achievement{
		{Key: "match_10", Name: "初入战局", Description: "累计完成 10 场有效比赛", Category: "match", GameType: 0, MetricKey: achievementx.MetricMatchesTotal, ProgressMode: achievementx.ProgressModeSum, Threshold: 10, Sort: 100, Status: 1},
		{Key: "match_100", Name: "百战磨砺", Description: "累计完成 100 场有效比赛", Category: "match", GameType: 0, MetricKey: achievementx.MetricMatchesTotal, ProgressMode: achievementx.ProgressModeSum, Threshold: 100, RewardTitleKey: "title_match_100", RewardTitleName: "资深球手", Sort: 110, Status: 1},
		{Key: "wins_10", Name: "十胜起步", Description: "累计赢下 10 场有效比赛", Category: "wins", GameType: 0, MetricKey: achievementx.MetricWinsTotal, ProgressMode: achievementx.ProgressModeSum, Threshold: 10, RewardTitleKey: "title_wins_10", RewardTitleName: "胜场新星", Sort: 200, Status: 1},
		{Key: "wins_100", Name: "百胜之路", Description: "累计赢下 100 场有效比赛", Category: "wins", GameType: 0, MetricKey: achievementx.MetricWinsTotal, ProgressMode: achievementx.ProgressModeSum, Threshold: 100, RewardTitleKey: "title_wins_100", RewardTitleName: "百胜球手", Sort: 210, Status: 1},
		{Key: "streak_5", Name: "连胜猎手", Description: "个人最高连胜达到 5 场", Category: "streak", GameType: 0, MetricKey: achievementx.MetricMaxWinStreak, ProgressMode: achievementx.ProgressModeMax, Threshold: 5, RewardTitleKey: "title_streak_5", RewardTitleName: "连胜猎手", Sort: 300, Status: 1},
		{Key: "streak_10", Name: "不败锋芒", Description: "个人最高连胜达到 10 场", Category: "streak", GameType: 0, MetricKey: achievementx.MetricMaxWinStreak, ProgressMode: achievementx.ProgressModeMax, Threshold: 10, RewardTitleKey: "title_streak_10", RewardTitleName: "不败王者", Sort: 310, Status: 1},
		{Key: "break_clear_1", Name: "首次清台", Description: "累计打出 1 次炸清", Category: "special", GameType: 0, MetricKey: achievementx.MetricBreakClearTotal, ProgressMode: achievementx.ProgressModeSum, Threshold: 1, RewardTitleKey: "title_break_clear_1", RewardTitleName: "清台猎手", Sort: 400, Status: 1},
		{Key: "break_clear_20", Name: "炸清大师", Description: "累计打出 20 次炸清", Category: "special", GameType: 0, MetricKey: achievementx.MetricBreakClearTotal, ProgressMode: achievementx.ProgressModeSum, Threshold: 20, RewardTitleKey: "title_break_clear_20", RewardTitleName: "炸清大师", Sort: 410, Status: 1},
		{Key: "break_147_1", Name: "满分时刻", Description: "累计打出 1 次单杆 147", Category: "special", GameType: 0, MetricKey: achievementx.MetricBreak147Total, ProgressMode: achievementx.ProgressModeSum, Threshold: 1, RewardTitleKey: "title_break_147_1", RewardTitleName: "满分王", Sort: 420, Status: 1},
	}
	for i := range defs {
		if err := svcCtx.DB.Clauses(clause.OnConflict{
			Columns: []clause.Column{{Name: "key"}},
			DoUpdates: clause.AssignmentColumns([]string{
				"name", "description", "category", "game_type", "metric_key", "progress_mode",
