...
test('h2h record page merges calendar and list into one month-filtered history section', () => {
  ...
  assert.match(source, /getH2HOverview\(buildH2HParams\(1\)\)/)
  assert.doesNotMatch(source, /getH2HStats\(/)
  assert.doesNotMatch(source, /fetchCalendarHistory|fetchMonthHistory/)
