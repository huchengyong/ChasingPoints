    ...
    <el-card class="config-card">
      ...
      <el-form :model="rewardConfig" label-width="120px" class="config-form" v-loading="configLoading">
        <div class="config-grid">
          ...
          <el-form-item label="新用户有效期">
            <el-input-number v-model="rewardConfig.new_user_window_days" :min="1" :max="90" />
          </el-form-item>
...
const fetchRewardConfig = async () => {
  ...
  try {
    ...
    if (res.success) {
      ...
      rewardConfig.new_user_window_days = res.new_user_window_days || 7
